    ...
    >
      ...
      <div className="flex-1 overflow-hidden px-4 py-2">
        {showAllUsers ? (
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          </span>
                          {
                            ...
                            text-white text-xs 
                            font-bold rounded-full min-w-[22px] h-5.5 flex
          ...
          text-center">
            <div className="p-4 bg-gray-800 roounded-full mb-4">
      ...
      <div className="p-4 border-t border-gray-700 space-y-2">
        ...
        className="w-full flex items-center gap-3 px-4 py-3 round-lg 
        hover:bg-red-600 transition-colors text-red-500 hover:text-white"
        >
