...
import React, { useRef, useState, useEffect } from "react";// import { clearInterval } from "timers";
...
const VerifyPage = () => {
    ...
    //when clicking backspace box would be empty
            ...
            <div className='max-w-md w-full'>
                <div className='bg-gray-800 border-gray-700 rounded-lg p-8'>
                    <div className='text-center mb-8'>
                        <div className='mx-auto w-20 h-20 bg-blue-600 rounded-lg flex 
                        ...
                        <p className='text-gray-300 text-lg'>We have sent a 6-digit code to your mail</p>
                    ...
                    <form onSubmit={handleSubmit}className="space-y-6">
                        ...
                        {
                            error && <div className="bg-red-900 border-red-700
                            rounded-lg p-3">
